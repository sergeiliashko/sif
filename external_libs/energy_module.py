...
p = Path(abs_path)
params_path = p.parent / 'required_params/python_neb_energy.cfg'
config = configparser.ConfigParser()
config.read(f"{params_path}")
clib_path = config.defaults()['clibs']

# load the library, using numpy mechanisms
libcd = npct.load_library(f"{clib_path}/energy", ".")
